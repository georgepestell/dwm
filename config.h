...
static const char *fonts[]          = { "monospace:size=16", "Font Awesome 5 Brands:style=Regular:size=14:antialias=true:autohint=true", "Font Awesome 5 Free:style=Solid:size=14:antialias=true:autohint=true","JoyPixels:pixelsize=14:antialias=true:autohint=true"};
static const char dmenufont[]       = "monospace:size=16"; static char normbgcolor[]           = "#222222";
...
static Key keys[] = {
	...
	{ MODKEY,												XK_l,			 spawn,					 SHCMD("xlock -mode blank -validate 'Trying Password...' -invalid 'Incorrect...'") },
